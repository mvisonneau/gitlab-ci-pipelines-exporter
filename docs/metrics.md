...
| `gitlab_ci_pipeline_job_timestamp` | Creation date timestamp of the most recent job | [project], [source_project], [topics], [ref], [runner_description], [kind], [source], [variables], [stage], [job_name], [tag_list], [failure_reason] | `project_defaults.pull.pipeline.jobs.enabled` |
