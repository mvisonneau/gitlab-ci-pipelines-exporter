...
// ListPipelineJobs ..
func (c *Client) ListPipelineJobs(ctx context.Context, projectID int64, pipelineID int64) (jobs []schemas.Job, err error) {
...
// ListPipelineBridges ..
func (c *Client) ListPipelineBridges(ctx context.Context, projectID int64, pipelineID int64) (bridges []*goGitlab.Bridge, err error) {
...
func (c *Client) ListPipelineChildJobs(ctx context.Context, projectID int64, parentPipelineID int64) (jobs []schemas.Job, err error) {
...
func (c *Client) ListRefMostRecentJobs(ctx context.Context, ref schemas.Ref) (jobs []schemas.Job, err error) {
	...
	for {
		...
		foundJobs, resp, err = c.Jobs.ListProjectJobs(projectName, opt, options...)
		if err != nil {
			return
		}
