...
func NewRegistry() *Registry {
	r := &Registry{
		...
		Collectors: RegistryCollectors{
			...
			schemas.MetricKindLastJobRunID:           NewCollectorLastJobRunID(),
			schemas.MetricKindLastRunDuration:        NewCollectorLastRunDuration(),
			schemas.MetricKindLastRunID:              NewCollectorLastRunID(),
			schemas.MetricKindLastRunJobArtifactSize: NewCollectorLastRunJobArtifactSize(),
			schemas.MetricKindLastRunJobDuration:     NewCollectorLastRunJobDuration(),
			schemas.MetricKindLastRunJobStatus:       NewCollectorLastRunJobStatus(),
			schemas.MetricKindLastRunStatus:          NewCollectorLastRunStatus(),
			schemas.MetricKindRunCount:               NewCollectorRunCount(),
			schemas.MetricKindTimeSinceLastJobRun:    NewCollectorTimeSinceLastJobRun(),
...
func MetricsHandler(w http.ResponseWriter, r *http.Request) {
	...
	promhttp.HandlerFor(registry, promhttp.HandlerOpts{
		Registry:          registry,
		EnableOpenMetrics: !Config.DisableOpenmetricsEncoding,
	}).ServeHTTP(w, r)
}
