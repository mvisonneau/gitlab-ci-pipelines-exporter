...
func NewRegistry() *Registry {
	r := &Registry{
		...
		Collectors: RegistryCollectors{
			...
			schemas.MetricKindJobLastRunArtifactSize: NewCollectorJobLastRunArtifactSize(),
			schemas.MetricKindJobLastRunDuration:     NewCollectorJobLastRunDuration(),
			schemas.MetricKindJobLastRunID:           NewCollectorJobLastRunID(),
			schemas.MetricKindJobLastRunStatus:       NewCollectorJobLastRunStatus(),
			schemas.MetricKindJobRunCount:            NewCollectorJobRunCount(),
			schemas.MetricKindJobTimeSinceLastRun:    NewCollectorJobTimeSinceLastRun(),
